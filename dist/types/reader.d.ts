 ...
 */
export declare function readUint32(buf: Buffer, offset: number, littleEndian: boolean): number;
/**
 ...
 */
export declare function readFloat64(buf: Buffer, offset: number, littleEndian: boolean): number;
