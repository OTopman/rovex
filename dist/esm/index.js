 ...
 * ```
 */
import { decodeLineString, decodePoint, decodePolygon, decodeMultiPoint, decodeMultiLineString, decodeMultiPolygon, } from './decoder.js';
import { normalise } from './normalize.js';
import { BYTE_ORDER_BIG_ENDIAN, BYTE_ORDER_LITTLE_ENDIAN, GEOMETRY_TYPE_MASK, OFFSET_WKB_TYPE, WKB_TYPE_POINT, WKB_TYPE_LINESTRING, WKB_TYPE_POLYGON, WKB_TYPE_MULTIPOINT, WKB_TYPE_MULTILINESTRING, WKB_TYPE_MULTIPOLYGON, } from './constants.js';
