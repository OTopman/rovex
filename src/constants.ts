 ...
 */
export const BYTE_ORDER_BIG_ENDIAN: 0 = 0;
export const BYTE_ORDER_LITTLE_ENDIAN: 1 = 1;

/**
 * Standard WKB geometry type identifiers (ISO 19125).
 * Lower 16 bits of the type field after masking EWKB flags.
 */
export const WKB_TYPE_POINT: 1 = 1;
export const WKB_TYPE_LINESTRING: 2 = 2;
export const WKB_TYPE_POLYGON: 3 = 3;
export const WKB_TYPE_MULTIPOINT: 4 = 4;
export const WKB_TYPE_MULTILINESTRING: 5 = 5;
export const WKB_TYPE_MULTIPOLYGON: 6 = 6;
 ...
 */
export const EWKB_SRID_FLAG = 0x20000000 as const;
 ...
 */
export const EWKB_Z_FLAG = 0x80000000 as const;
 ...
 *   TOTAL: 25 bytes
 */
export const POINT_MIN_BYTES = 25 as const;
