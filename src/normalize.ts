import { PG_HEX_PREFIX } from './constants.js';
 ...
 * @internal
 */
export function normalise(input: EwkbInput): Buffer | null {
  ...
  if (typeof input === 'string') {
    ...
    const hex = input.startsWith(PG_HEX_PREFIX) ? input.slice(2) : input;
